...
<div class="container-fluid">
    <div class="page-title">
        <div class="row">
            <div class="col-6">
                <h3>Data Laporan Proses</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#"><i data-feather="home"></i></a>
                    </li>
                    <li class="breadcrumb-item">Data Laporan Proses</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                            <h5>Laporan Approval Tahap 2</h5>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="display" id="basic-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $no }}</td>
                                    <td style="text-align: center">{{ date('d-m-Y', strtotime($laporan->created_at))}}</td>

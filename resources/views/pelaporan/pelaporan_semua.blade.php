                    ...
                    <div class="table-responsive">
                        <table class="display" id="basic-1">
                            ...
                            <tbody>
                                ...
                                $no = 1;
                                @endphp
                                @foreach ($data_semua_laporan as $laporan)
                                <tr>
                                    <td>{{$no}}</td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-form-label" for="nama_pengguna">Kronologi</label>
                                                            <textarea class="form-control" id="exampleFormControlTextarea25" readonly name="deskripsi" rows="4">{{$laporan->kronologi_kejadian}}</textarea>
                                                        </div>
                                                        <div class="form-group">

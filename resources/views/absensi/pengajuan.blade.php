...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="{{ route('form_tukar_shift', auth()->user()->nik) }}">
    ...
    <div class="row">
        <div class="col-md-6">
            <a href="{{ route('form_lembur', auth()->user()->nik) }}">
                <div class="card browser-widget">
                    <div class="media card-body align-self-center">
                        <div class="media-img">
        ...
        <div class="col-md-6">
            <a href="{{ route('form_lembur_khusus', auth()->user()->nik) }}">
                <div class="card browser-widget">
                    <div class="media card-body align-self-center">
                        <div class="media-img">
                            <img style="height: 250px;" src="{{ asset('assets/images/dashboard/lembur.png')}}" alt=""

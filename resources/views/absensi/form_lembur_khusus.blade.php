        ...
        <div class="row">
            ...
            <div class="col-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Form Lembur Khusus</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Form Lembur Khusus</h5>
                </div>
                <div class="card-body">
                    <form action="{{route('lembur_khusus_submit')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form theme-form">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Tanggal Lembur Khusus</label>
                                        <input autocomplete="off" class="datepicker-here form-control" name="tgl_lembur_khusus"
                                            type="text" placeholder="Tanggal Lembur Khusus " data-language="en"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Total Jam Lembur Khusus</label>
                                        <input class="form-control" min="1" max="8" type="number" placeholder="Total Jam" id="total_jam_lembur_khusus" name="total_jam_lembur_khusus"
                                            required>
                                        {{-- <input type="text" value="Ijin" name="tipe_absen" hidden> --}}
                                    </div>
                                </div>
        ...
        $("#nik").change(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#direct_jab_atasan').val(data.karyawan.jabatan.atasan_1
                    .nama_lengkap);
                    $('#id_user_penerima').val(data.karyawan.jabatan.atasan_1.user.id_user);
                    $('#direct_jab_atasan_2').val(data.karyawan.jabatan.atasan_2
                        .nama_lengkap);
                    $('#foto').attr('src', "{{asset('assets/foto_profil')}}/" + data
                        .karyawan.user.foto);
                }
            });
        });

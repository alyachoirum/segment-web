        ...
        <div class="row">
            ...
            <div class="col-9">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Form Cuti</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-2" style="text-align: right">
                            <p>Sisa Cuti Anda = <b>{{ $sisa_cuti->sisa_cuti }}</b></p>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('cuti_submit')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" class="datepicker-here form-control" name="tgl_absen" type="text"
                                            placeholder="Tanggal Cuti" data-language="en" data-original-title=""
                                            title="">
                                        <input type="text" value="Cuti" name="tipe_absen" hidden>
                                    </div>
                                </div>
                            </div>
                            <div class="row">

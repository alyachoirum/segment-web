        ...
        <div class="row">
            ...
            <div class="col-9">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Form Ijin</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('ijin_submit')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                                ...
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <select class="js-example-basic-single col-sm-12" id="nik" required>
                                            <option value="">Pilih NIK atau Nama Karyawan</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        placeholder="Tanggal Ijin" data-language="en" data-original-title="" title="" required>

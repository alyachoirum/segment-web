        ...
        <div class="col-sm-12 col-xl-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h5 class="text-white" style="text-align: center">Data Lembur Khusus</h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs border-tab" id="top-tab" role="tablist">
                        <li class="nav-item"><a class="nav-link active" id="top-home-tab" data-toggle="tab"
                                ...
                                data-original-title="" title=""><i class="icofont icofont-map-search"></i></i>Belum Validasi <span class="badge badge-pill badge-warning">{{ $total_belum_valid }}
                                </a></li>
                        ...
                        <div class="tab-pane fade show active" id="top-home" role="tabpanel" aria-labelledby="top-home-tab">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="display" id="tabel_lembur_khusus">
                                        <thead>
                                            <tr>
                                                <th style="text-align: center">Tgl LK</th>
                                                <th style="text-align: center">NIK</th>
                                                <th style="text-align: center">Nama</th>
                                                <th style="text-align: center">Tot Jam</th>
                                                <th style="text-align: center">Keterangan</th>
                                                <th style="text-align: center">Kajaga</th>
                                                <th style="text-align: center">Kasi</th>
                                                <th style="text-align: center">Kabag</th>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="display" id="sudah_validasi">
                                        <thead>
                                            <tr>
                                                <th width="50px">Tgl Lembur Khs</th>
                                                <th width="1px">NIK</th>
                        ...
                        <div class="tab-pane fade" id="top-reject" role="tabpanel" aria-labelledby="profile-top-tab">
                            <div class="card-body">
                                <div class="dt-ext table-responsive">
                                    <table class="display" id="tabel_lk_reject">
                                        <thead>
                                            <tr>
                                                <th width="50px">Tgl Lembur Khs</th>
                                                <th width="1px">NIK</th>
...
<script>
    ...
    $(document).ready(function () {
        $('#tabel_lembur_khusus').DataTable({
            processing: true,
            serverSide: true, //aktifkan server-side
            ajax: {
                url: "{{ route('list_lembur_khusus')}}",
                type: 'GET'
            },
            columns: [
                {
                    data: 'tgl_lembur_khusus',
                    name: 'tgl_lembur_khusus',
                    orderable: false,
                },
                {
                    data: 'nik',
                ...
                {
                    data: 'total_jam_lembur_khusus',
                    name: 'total_jam_lembur_khusus'
                },
                {
                    data: 'detail_lembur_khusus',
                    name: 'detail_lembur_khusus'
                },
                {
                    data: 'validasi',
                    name: 'validasi'
...
<script>
    ...
    $(document).ready(function () {
        $('#sudah_validasi').DataTable({
            ...
            serverSide: true, //aktifkan server-side
            ajax: {
                url: "{{ route('data_lembur_khusus_sudah_valid')}}",
                type: 'GET'
            },
            columns: [
                {
...
<script>
    ...
    //script untuk memanggil data json dari server dan menampilkannya berupa datatable
    $(document).ready(function () {
        $('#tabel_lk_reject').DataTable({
            processing: true,
            serverSide: true, //aktifkan server-side
            ajax: {
                url: "{{ route('data_lembur_khusus_reject')}}",
                type: 'GET'
            },
            columns: [
                {

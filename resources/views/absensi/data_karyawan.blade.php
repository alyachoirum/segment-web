...
<div class="container-fluid">
    ...
    <div class="alert alert-success dark alert-dismissible fade show" role="alert">
        <strong>Tambah Karyawan Berhasil !</strong>
    ...
    <div class="alert alert-success dark alert-dismissible fade show" role="alert">
        <strong>Edit Karyawan Berhasil !</strong>
        <button class="close" type="button" data-dismiss="alert" aria-label="Close" data-original-title=""
            title=""><span aria-hidden="true">×</span></button>
    </div>
    @elseif( $massage = Session::get('hapus_success'))
    <div class="alert alert-success dark alert-dismissible fade show" role="alert">
        <strong>Hapus Karyawan Berhasil !</strong>
        <button class="close" type="button" data-dismiss="alert" aria-label="Close" data-original-title=""
            title=""><span aria-hidden="true">×</span></button>
    </div>
    @endif
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    {{-- <div class="row">
                        <form action="{{route('data_karyawan_filter')}}" method="post">
                        {{ csrf_field() }}
                            <div class="form-group row" style="padding-left:4%">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label>Zona Kerja</label>
                                        <select class="form-control button btn btn-outline-primary js-example-basic-single col-sm-12" name="id_zona" id="id_zona">
